...
const Sidebar: NextPage = () => {
  ...
  return (
    <div className="flex flex-col justify-between h-screen text-gray-500 p-6 text-sm border-r border-gray-900">
      <div className="font-medium space-y-8">
        ...
        <div className="space-y-2">
          <button className="flex items-center space-x-3">
            ...
            <span className="hover:text-white">Create Playlist</span>
          </button>
          <button className="flex items-center space-x-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="hover:text-white">Liked Songs</span>
          </button>
        </div>
        <hr className="border-t border-gray-900" />
        <div className="space-y-2">
          <span className="font-normal text-base cursor-pointer hover:text-white">
            New Playlist 1
          </span>
        </div>
      </div>
      <div className="font-medium">
        <button onClick={() => signOut()} className="flex items-center space-x-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          <span className="hover:text-white">Log Out</span>
        </button>
      </div>
    </div>
  );
