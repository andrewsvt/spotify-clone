...
const Sidebar: NextPage = () => {
  ...
  return (
    <div className="hidden md:flex flex-col justify-between h-screen text-gray-500 text-xs lg:text-sm border-r border-gray-900 overflow-y-scroll scrollbar-hide max-w-[12rem] lg:max-w-[15rem] w-full">
      <div className="flex flex-col font-medium space-y-8">
        ...
        <div className="flex flex-col space-y-3 pl-6 max-h-[50vh] overflow-auto">
      ...
      <div className="sticky bg-black p-6 pt-3 left-0 bottom-[4.75rem] font-medium w-full">
        <button onClick={() => signOut()} className="flex items-center space-x-3 hover:text-white">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
